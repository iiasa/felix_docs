...
This is the full-version documentation of FeliX 2.0. This documentation stands alone as a technical documentation of FeliX, and also supports the [scientific publication](https://doi.org/10.1016/j.envsoft.2024.106121) of FeliX.
...
|:--|
|Figure 3. Overview of the FeliX model. We include 11 components in the figure to better illustrate interactions within and among the modules. As such, education shows as a separate component from population, and fertilizer use shows separate from land use. Source: [Moallemi et al. (2022)](https://linkinghub.elsevier.com/retrieve/pii/S2590332222003244).|
